    ...
    if ($("#filter-column").length > 0) {
        ...
        function changeSize() {
            if ($(window).width() < 750) {
                ...
                let minHeight = parseInt($("#search-row").css("height")) + parseInt($("#initial-filters").css("height")) + parseInt($("#filter-header").css("height")) + parseInt($("#filter-more").css("height")) + 64 + 40;
